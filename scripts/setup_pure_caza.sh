...
sed -i -e   's/^logname .*/logname pure_caza.log/' \
       ...
       -e   's/^lower_level_policy_fallback .*/lower_level_policy_fallback kCAZA/' \
       -e   's/^middle_level_policy .*/middle_level_policy kCAZA/' \
       -e   's/^middle_level_policy_fallback .*/middle_level_policy_fallback kCAZA/' \
       ${PARAMFILE}
